...
**`six-lessons.png` is deliberately NOT in the article** — it duplicates the recommendations prose. It
is the image for the share post instead, where it stands alone and is the most saveable asset in the set.
